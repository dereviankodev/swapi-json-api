 ...
 * @method void setVehicleClass(string $vehicle_class)
...
class Vehicle extends BaseModel
{
    public static function create(array $attributes): static
    {
        ...
        $planet->setVehicleClass($attributes['vehicle_class']);
    ...
    {
        return array_key_exists($arguments, $this->relations) || $this->relationLoad(new VehicleRepository(), $this->getId());
    }
}
